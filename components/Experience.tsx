...
const jobs = [
  {
    ...
    period: "2010 - 2026",
    description:
      "Development of ISR360, a large cross-platform wxWidgets application used to develop and evaluate tracking algorithms for industrial and defence applications.",
    anchor: "trackgen",
  },
  {
    company: "Dexlabs",
